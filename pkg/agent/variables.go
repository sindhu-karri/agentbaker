...
func getCustomDataVariables(config *datamodel.NodeBootstrappingConfiguration) paramsMap {
	...
	cloudInitFiles := map[string]interface{}{
		"cloudInitData": paramsMap{
			...
			"provisionSourceFedora":                 getBase64EncodedGzippedCustomScript(kubernetesCSEHelpersScriptFedora, config),
			...
			"provisionInstallsFedora":               getBase64EncodedGzippedCustomScript(kubernetesCSEInstallFedora, config),
