...
const (
	...
	kubernetesCSEHelpersScriptFedora      = "linux/cloud-init/artifacts/fedora/cse_helpers_fedora.sh"
	...
	kubernetesCSEInstallFedora            = "linux/cloud-init/artifacts/fedora/cse_install_fedora.sh"
